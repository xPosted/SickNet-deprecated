...
<script src="style/js/bootstrap.min.js"></script>
	<script src="style/js/strimx.js"></script>
		...
		<div style="margin-left: auto; margin-right: auto; width: 1000px;"
			...
			<div style="padding-top: 0px; padding-bottom: 0px;" class="panel-body">
							...
							<ul  style="display:block; text-decoration:none; float:left; margin-left: 280px; margin-bottom: 0px;" >
								...
								<li  style="display:block; float: left;"><a  href="Nodes?public=true" style="text-decoration: none; display: block; color:gray; padding:15px;;">Public</a></li>
								<li  style="display:block; float: left;" ><a href="Nodes?public=false" style="text-decoration: none; display: block; padding:15px; color: gray;">Own</a> </li>
...
<div class="panel panel-default" id="LeftPanel" style="margin-left:50px; display: none; position: absolute; width: 220px; float: left; height: 250px;">
<div class="panel-heading" style="text-align: center;" id="nodeName"> [Node name]</div>
<div class="panel-body" id="bodyName">
<table style="width: 180px;" class="table table-default" id="tableBody">
<tr>
	<th> Owner:
	<td id="nodeOwner"> 
</tr>
