...
(function() {
  ...
  LD("json_ld_keywords",
    '{',
    '  [meta "@context"]: {',
    '    [meta "@base"]: [string "protocol://example.com"],',
    '    [meta "@vocab"]: [string "protocol://xmlns.com/foaf/0.1/"],',
    ...
    '  },',
    '  [meta "@graph"]: [[ {',
    '    [meta "@id"]: [string "protocol://dbpedia.org/resource/John_Lennon"],',
    '    [property "name"]: [string "John Lennon"],',
    '    [property "modified"]: {',
    '      [meta "@value"]: [string "2010-05-29T14:17:39+02:00"],',
    '      [meta "@type"]: [string "protocol://www.w3.org/2001/XMLSchema#dateTime"]',
    '    }',
    '  } ]]',
    '}');
