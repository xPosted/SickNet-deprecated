...
(function() {
  ...
  FT("formatting_link",
     "[link&formatting&formatting-link [][link foo][link&formatting&formatting-link ]]][string&formatting&formatting-link-string (][string protocol://example.com/][string&formatting&formatting-link-string )]");
  ...
  FT("formatting_linkReference",
     ...
     "[link&formatting&formatting-link [][link bar][link&formatting&formatting-link ]]:] [string protocol://example.com/]");

  FT("formatting_linkWeb",
     "[link&formatting&formatting-link <][link protocol://example.com/][link&formatting&formatting-link >]");
  ...
  MT("linkTitle",
     "[link [[foo]]][string (protocol://example.com/ \"bar\")] hello");

  // Inline link without title
  MT("linkNoTitle",
     "[link [[foo]]][string (protocol://example.com/)] bar");

  // Inline link with image
  MT("linkImage",
     "[link [[][tag ![[foo]]][string (protocol://example.com/)][link ]]][string (protocol://example.com/)] bar");

  // Inline link with Em
  MT("linkEm",
     "[link [[][link&em *foo*][link ]]][string (protocol://example.com/)] bar");

  // Inline link with Strong
  MT("linkStrong",
     "[link [[][link&strong **foo**][link ]]][string (protocol://example.com/)] bar");

  // Inline link with EmStrong
  MT("linkEmStrong",
     "[link [[][link&strong **][link&em&strong *foo**][link&em *][link ]]][string (protocol://example.com/)] bar");

  // Image with title
  MT("imageTitle",
     "[tag ![[foo]]][string (protocol://example.com/ \"bar\")] hello");

  // Image without title
  MT("imageNoTitle",
     "[tag ![[foo]]][string (protocol://example.com/)] bar");
  ...
  MT("labelNoTitle",
     "[link [[foo]]:] [string protocol://example.com/]");

  MT("labelIndented",
     "   [link [[foo]]:] [string protocol://example.com/]");

  MT("labelSpaceTitle",
     "[link [[foo bar]]:] [string protocol://example.com/ \"hello\"]");

  MT("labelDoubleTitle",
     "[link [[foo bar]]:] [string protocol://example.com/ \"hello\"] \"world\"");
  ...
  MT("linkWeb",
     "[link <protocol://example.com/>] foo");

  MT("linkWebDouble",
     "[link <protocol://example.com/>] foo [link <protocol://example.com/>]");
  ...
  MT("xmlMode",
     ...
     "*foo*",
     "[tag&bracket <][tag protocol://github.com][tag&bracket />]",
     "[tag&bracket </][tag div][tag&bracket >]",
     "[link <protocol://github.com/>]");
