...
jvm.SVGElement.svgns = "protocol://www.w3.org/2000/svg";
  ...
  if (attr === 'fill' && jvm.isImageUrl(value)) {
    if (!jvm.SVGShapeElement.images[value]) {
      jvm.whenImageLoaded(value).then(function(img){
        ...
        imageEl.node.setAttributeNS('protocol://www.w3.org/1999/xlink', 'href', value);
...
jvm.SVGImageElement.prototype.applyAttr = function(attr, value){
  ...
  if (attr == 'image') {
    jvm.whenImageLoaded(value).then(function(img){
      that.node.setAttributeNS('protocol://www.w3.org/1999/xlink', 'href', value);
